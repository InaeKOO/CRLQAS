...
I_ptm_0_3 = I(0,6)#np.load(f"./PTM_files/mumbai/q3/I_ptm_0_3_mumbai_median.npy")

I_ptm_1_3 = I(0,6)#np.load(f"./PTM_files/mumbai/q3/I_ptm_1_3_mumbai_median.npy")

I_ptm_2_3 = I(0,6)#np.load(f"./PTM_files/mumbai/q3/I_ptm_2_3_mumbai_median.npy")

X_ptm_0_3 = np.load(f"./PTM_files/q3/{encoding}/X_ptm_0_3.npy")

Y_ptm_0_3 = np.load(f"./PTM_files/q3/{encoding}/Y_ptm_0_3.npy")

Z_ptm_0_3 = np.load(f"./PTM_files/q3/{encoding}/Z_ptm_0_3.npy")


X_commute_ptm_0_3 = np.load(f"./PTM_files/q3/{encoding}/X_commute_ptm_0_3.npy")

Y_commute_ptm_0_3 = np.load(f"./PTM_files/q3/{encoding}/Y_commute_ptm_0_3.npy")

Z_commute_ptm_0_3 = np.load(f"./PTM_files/q3/{encoding}/Z_commute_ptm_0_3.npy")


X_ptm_1_3 = np.load(f"./PTM_files/q3/{encoding}/X_ptm_1_3.npy")

Y_ptm_1_3 = np.load(f"./PTM_files/q3/{encoding}/Y_ptm_1_3.npy")

Z_ptm_1_3 = np.load(f"./PTM_files/q3/{encoding}/Z_ptm_1_3.npy")


X_commute_ptm_1_3 = np.load(f"./PTM_files/q3/{encoding}/X_commute_ptm_1_3.npy")

Y_commute_ptm_1_3 = np.load(f"./PTM_files/q3/{encoding}/Y_commute_ptm_1_3.npy")

Z_commute_ptm_1_3 = np.load(f"./PTM_files/q3/{encoding}/Z_commute_ptm_1_3.npy")


X_ptm_2_3 = np.load(f"./PTM_files/q3/{encoding}/X_ptm_2_3.npy")

Y_ptm_2_3 = np.load(f"./PTM_files/q3/{encoding}/Y_ptm_2_3.npy")

Z_ptm_2_3 = np.load(f"./PTM_files/q3/{encoding}/Z_ptm_2_3.npy")


X_commute_ptm_2_3 = np.load(f"./PTM_files/q3/{encoding}/X_commute_ptm_2_3.npy")

Y_commute_ptm_2_3 = np.load(f"./PTM_files/q3/{encoding}/Y_commute_ptm_2_3.npy")

Z_commute_ptm_2_3 = np.load(f"./PTM_files/q3/{encoding}/Z_commute_ptm_2_3.npy")
...
ops_ptm_3q[0,0,:,:] = I_ptm_0_3

ops_ptm_3q[0,1,:,:] = X_ptm_0_3

ops_ptm_3q[0,2,:,:] = X_commute_ptm_0_3


ops_ptm_3q[1,0,:,:] = I_ptm_0_3

ops_ptm_3q[1,1,:,:] = Y_ptm_0_3

ops_ptm_3q[1,2,:,:] = Y_commute_ptm_0_3


ops_ptm_3q[2,0,:,:] = I_ptm_0_3

ops_ptm_3q[2,1,:,:] = Z_ptm_0_3

ops_ptm_3q[2,2,:,:] = Z_commute_ptm_0_3


##

ops_ptm_3q[3,0,:,:] = I_ptm_1_3

ops_ptm_3q[3,1,:,:] = X_ptm_1_3

ops_ptm_3q[3,2,:,:] = X_commute_ptm_1_3


ops_ptm_3q[4,0,:,:] = I_ptm_1_3

ops_ptm_3q[4,1,:,:] = Y_ptm_1_3

ops_ptm_3q[4,2,:,:] = Y_commute_ptm_1_3


ops_ptm_3q[5,0,:,:] = I_ptm_1_3

ops_ptm_3q[5,1,:,:] = Z_ptm_1_3

ops_ptm_3q[5,2,:,:] = Z_commute_ptm_1_3


##

ops_ptm_3q[6,0,:,:] = I_ptm_2_3

ops_ptm_3q[6,1,:,:] = X_ptm_2_3

ops_ptm_3q[6,2,:,:] = X_commute_ptm_2_3


ops_ptm_3q[7,0,:,:] = I_ptm_2_3

ops_ptm_3q[7,1,:,:] = Y_ptm_2_3

ops_ptm_3q[7,2,:,:] = Y_commute_ptm_2_3


ops_ptm_3q[8,0,:,:] = I_ptm_2_3

ops_ptm_3q[8,1,:,:] = Z_ptm_2_3

ops_ptm_3q[8,2,:,:] = Z_commute_ptm_2_3
