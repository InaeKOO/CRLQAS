...
X_ptm_0_2 = np.load(f"./PTM_files/q2/{encoding}/X_ptm_0_2.npy")

X_commute_ptm_0_2 = np.load(f"./PTM_files/q2/{encoding}/X_commute_ptm_0_2.npy")

Y_ptm_0_2 = np.load(f"./PTM_files/q2/{encoding}/Y_ptm_0_2.npy")

Y_commute_ptm_0_2 = np.load(f"./PTM_files/q2/{encoding}/Y_commute_ptm_0_2.npy")

Z_ptm_0_2 = np.load(f"./PTM_files/q2/{encoding}/Z_ptm_0_2.npy")

Z_commute_ptm_0_2 = np.load(f"./PTM_files/q2/{encoding}/Z_commute_ptm_0_2.npy")

X_ptm_1_2 = np.load(f"./PTM_files/q2/{encoding}/X_ptm_1_2.npy")

X_commute_ptm_1_2 = np.load(f"./PTM_files/q2/{encoding}/X_commute_ptm_1_2.npy")

Y_ptm_1_2 = np.load(f"./PTM_files/q2/{encoding}/Y_ptm_1_2.npy")

Y_commute_ptm_1_2 = np.load(f"./PTM_files/q2/{encoding}/Y_commute_ptm_1_2.npy")

Z_ptm_1_2 = np.load(f"./PTM_files/q2/{encoding}/Z_ptm_1_2.npy")

Z_commute_ptm_1_2 = np.load(f"./PTM_files/q2/{encoding}/Z_commute_ptm_1_2.npy")

cx_01_2_ptm = np.load(f"./PTM_files/q2/{encoding}/cx_ptm_01_2.npy")

cx_10_2_ptm = np.load(f"./PTM_files/q2/{encoding}/cx_ptm_10_2.npy")
