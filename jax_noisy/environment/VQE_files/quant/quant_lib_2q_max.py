...
# if problem == "max":
print("running max 2q problem")
ReadOut_ptm_2 =  np.load(
    f"./PTM_files/mumbai/q2/max/{encoding}/ReadOut_ptm_mumbai_2q_max.npy")

I_ptm_0_2 =  np.load(f"./PTM_files/mumbai/q2/max/{encoding}/I_ptm_0_2_mumbai_max.npy")

I_ptm_1_2 =  np.load(f"./PTM_files/mumbai/q2/max/{encoding}/I_ptm_1_2_mumbai_max.npy")

X_ptm_0_2 =  np.load(f"./PTM_files/mumbai/q2/max/{encoding}/X_ptm_0_2_mumbai_max.npy")

X_commute_0_2_ptm =  np.load(
    f"./PTM_files/mumbai/q2/max/{encoding}/X_commute_ptm_0_2_mumbai_max.npy")

# print(X_ptm_0_2)

Y_ptm_0_2 =  np.load(f"./PTM_files/mumbai/q2/max/{encoding}/Y_ptm_0_2_mumbai_max.npy")

Y_commute_ptm_0_2 =  np.load(
    f"./PTM_files/mumbai/q2/max/{encoding}/Y_commute_ptm_0_2_mumbai_max.npy")

Z_ptm_0_2 =  np.load(f"./PTM_files/mumbai/q2/max/{encoding}/Z_ptm_0_2_mumbai_max.npy")

Z_commute_ptm_0_2 =  np.load(
    f"./PTM_files/mumbai/q2/max/{encoding}/Z_commute_ptm_0_2_mumbai_max.npy")

X_ptm_1_2 =  np.load(f"./PTM_files/mumbai/q2/max/{encoding}/X_ptm_1_2_mumbai_max.npy")

X_commute_1_2_ptm =  np.load(
    f"./PTM_files/mumbai/q2/max/{encoding}/X_commute_ptm_1_2_mumbai_max.npy")

Y_ptm_1_2 =  np.load(f"./PTM_files/mumbai/q2/max/{encoding}/Y_ptm_1_2_mumbai_max.npy")

Y_commute_ptm_1_2 =  np.load(
    f"./PTM_files/mumbai/q2/max/{encoding}/Y_commute_ptm_1_2_mumbai_max.npy")

Z_ptm_1_2 =  np.load(f"./PTM_files/mumbai/q2/max/{encoding}/Z_ptm_1_2_mumbai_max.npy")

Z_commute_1_2_ptm =  np.load(
    f"./PTM_files/mumbai/q2/max/{encoding}/Z_commute_ptm_1_2_mumbai_max.npy")

cx_ptm_01_2 =  np.load(f"./PTM_files/mumbai/q2/max/{encoding}/cx_ptm_01_2_two_mumbai_max.npy")

cx_ptm_10_2 =  np.load(f"./PTM_files/mumbai/q2/max/{encoding}/cx_ptm_10_2_two_mumbai_max.npy")
...
ops_ptm_2q[0,2,:,:] = X_commute_0_2_ptm
...
ops_ptm_2q[3,2,:,:] = X_commute_1_2_ptm
...
ops_ptm_2q[5,2,:,:] = Z_commute_1_2_ptm
##
