...
I_ptm_0_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Dep_ptm_0_4_0p001.npy")

I_ptm_1_4=  np.load(f"./PTM_files/q4/{encoding}/0p001/Dep_ptm_1_4_0p001.npy")

I_ptm_2_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Dep_ptm_2_4_0p001.npy")

I_ptm_3_4=  np.load(f"./PTM_files/q4/{encoding}/0p001/Dep_ptm_3_4_0p001.npy")

cx_ptm_01_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_01_4_0p005.npy")

cx_ptm_02_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_02_4_0p005.npy")

cx_ptm_03_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_03_4_0p005.npy")

cx_ptm_10_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_10_4_0p005.npy")

cx_ptm_12_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_12_4_0p005.npy")

cx_ptm_13_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_13_4_0p005.npy")

cx_ptm_20_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_20_4_0p005.npy")

cx_ptm_21_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_21_4_0p005.npy")

cx_ptm_23_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_23_4_0p005.npy")

cx_ptm_30_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_30_4_0p005.npy")

cx_ptm_31_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_31_4_0p005.npy")

cx_ptm_32_4 =  np.load(f"./PTM_files/q4/{encoding}/0p005/cx_ptm_32_4_0p005.npy")

X_ptm_0_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/X_ptm_0_4_0p001.npy")

Y_ptm_0_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Y_ptm_0_4_0p001.npy")

Z_ptm_0_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Z_ptm_0_4_0p001.npy")

X_ptm_1_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/X_ptm_1_4_0p001.npy")

Y_ptm_1_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Y_ptm_1_4_0p001.npy")

Z_ptm_1_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Z_ptm_1_4_0p001.npy")

X_ptm_2_4  =  np.load(f"./PTM_files/q4/{encoding}/0p001/X_ptm_2_4_0p001.npy")

Y_ptm_2_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Y_ptm_2_4_0p001.npy")

Z_ptm_2_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Z_ptm_2_4_0p001.npy")

X_ptm_3_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/X_ptm_3_4_0p001.npy")

Y_ptm_3_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Y_ptm_3_4_0p001.npy")

Z_ptm_3_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Z_ptm_3_4_0p001.npy")

X_commute_ptm_0_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/X_commute_ptm_0_4_0p001.npy")

Y_commute_ptm_0_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Y_commute_ptm_0_4_0p001.npy")

Z_commute_ptm_0_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Z_commute_ptm_0_4_0p001.npy")

X_commute_ptm_1_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/X_commute_ptm_1_4_0p001.npy")

Y_commute_ptm_1_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Y_commute_ptm_1_4_0p001.npy")

Z_commute_ptm_1_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Z_commute_ptm_1_4_0p001.npy")

X_commute_ptm_2_4  =  np.load(f"./PTM_files/q4/{encoding}/0p001/X_commute_ptm_2_4_0p001.npy")

Y_commute_ptm_2_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Y_commute_ptm_2_4_0p001.npy")

Z_commute_ptm_2_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Z_commute_ptm_2_4_0p001.npy")

X_commute_ptm_3_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/X_commute_ptm_3_4_0p001.npy")

Y_commute_ptm_3_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Y_commute_ptm_3_4_0p001.npy")

Z_commute_ptm_3_4 =  np.load(f"./PTM_files/q4/{encoding}/0p001/Z_commute_ptm_3_4_0p001.npy")
