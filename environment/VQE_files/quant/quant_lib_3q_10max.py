...
ReadOut_3_ptm = np.load(f"./PTM_files/mumbai/q3//max/{encoding}/ReadOut_ptm_mumbai_3q_max.npy")

I_0_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/I_ptm_0_3_mumbai_10max.npy")

I_1_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/I_ptm_1_3_mumbai_10max.npy")

I_2_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/I_ptm_2_3_mumbai_10max.npy")


X_0_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/X_ptm_0_3_mumbai_10max.npy")

Y_0_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Y_ptm_0_3_mumbai_10max.npy")

Z_0_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Z_ptm_0_3_mumbai_10max.npy")


X_commute_0_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/X_commute_ptm_0_3_mumbai_10max.npy")

Y_commute_0_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Y_commute_ptm_0_3_mumbai_10max.npy")

Z_commute_0_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Z_commute_ptm_0_3_mumbai_10max.npy")


X_1_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/X_ptm_1_3_mumbai_10max.npy")

Y_1_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Y_ptm_1_3_mumbai_10max.npy")

Z_1_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Z_ptm_1_3_mumbai_10max.npy")


X_commute_1_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/X_commute_ptm_1_3_mumbai_10max.npy")

Y_commute_1_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Y_commute_ptm_1_3_mumbai_10max.npy")

Z_commute_1_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Z_commute_ptm_1_3_mumbai_10max.npy")


X_2_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/X_ptm_2_3_mumbai_10max.npy")

Y_2_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Y_ptm_2_3_mumbai_10max.npy")

Z_2_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Z_ptm_2_3_mumbai_10max.npy")


X_commute_2_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/X_commute_ptm_2_3_mumbai_10max.npy")

Y_commute_2_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Y_commute_ptm_2_3_mumbai_10max.npy")

Z_commute_2_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/Z_commute_ptm_2_3_mumbai_10max.npy")


cx_01_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/cx_ptm_01_3_two_mumbai_10max.npy")

cx_02_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/cx_ptm_02_3_two_mumbai_10max.npy")

cx_10_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/cx_ptm_10_3_two_mumbai_10max.npy")

cx_12_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/cx_ptm_12_3_two_mumbai_10max.npy")

cx_20_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/cx_ptm_20_3_two_mumbai_10max.npy")

cx_21_3_ptm = np.load(f"./PTM_files/mumbai/q3/10max/{encoding}/cx_ptm_21_3_two_mumbai_10max.npy")
