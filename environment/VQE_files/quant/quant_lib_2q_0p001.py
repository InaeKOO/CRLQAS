...
ops_2q[0,0,:,:] = I(0,2)  #Dep_0_4_mumbai_ptm

ops_2q[0,1,:,:] = X(0,2)  #X_0_4_mumbai_ptm

ops_2q[1,0,:,:] = I(0,2)  #Dep_0_4_mumbai_ptm

ops_2q[1,1,:,:] = Y(0,2)  #Y_0_4_mumbai_ptm

ops_2q[2,0,:,:] = I(0,2)  #Dep_0_4_mumbai_ptm

ops_2q[2,1,:,:] = Z(0,2)  #Z_0_4_mumbai_ptm

##

ops_2q[3,0,:,:] = I(0,2)  #Dep_1_4_mumbai_ptm

ops_2q[3,1,:,:] = X(1,2)  #X_1_4_mumbai_ptm

ops_2q[4,0,:,:] = I(0,2)  #Dep_1_4_mumbai_ptm

ops_2q[4,1,:,:] = Y(1,2)  #Y_1_4_mumbai_ptm

ops_2q[5,0,:,:] = I(0,2)  #Dep_1_4_mumbai_ptm

ops_2q[5,1,:,:] = Z(1,2)  #Z_1_4_mumbai_ptm
...
ReadOut_ptm_2 = I(0, 4)  # np.load(f"./PTM_files/mumbai/q2/ReadOut_ptm_mumbai_2q_median.npy")

I_ptm_0_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/I_ptm_0_2_0p001.npy")

I_ptm_1_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/I_ptm_1_2_0p001.npy")

X_ptm_0_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/X_ptm_0_2_0p001.npy")

X_commute_ptm_0_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/X_commute_ptm_0_2_0p001.npy")

Y_ptm_0_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/Y_ptm_0_2_0p001.npy")

Y_commute_ptm_0_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/Y_commute_ptm_0_2_0p001.npy")

Z_ptm_0_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/Z_ptm_0_2_0p001.npy")

Z_commute_ptm_0_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/Z_commute_ptm_0_2_0p001.npy")

X_ptm_1_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/X_ptm_1_2_0p001.npy")

X_commute_ptm_1_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/X_commute_ptm_1_2_0p001.npy")

Y_ptm_1_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/Y_ptm_1_2_0p001.npy")

Y_commute_ptm_1_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/Y_commute_ptm_1_2_0p001.npy")

Z_ptm_1_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/Z_ptm_1_2_0p001.npy")

Z_commute_ptm_1_2 =  np.load(f"./PTM_files/q2/{encoding}/0p001/Z_commute_ptm_1_2_0p001.npy")

cx_ptm_01_2 =  np.load(f"./PTM_files/q2/{encoding}/cx_ptm_01_2.npy")

cx_ptm_10_2 =  np.load(f"./PTM_files/q2/{encoding}/cx_ptm_10_2.npy")
