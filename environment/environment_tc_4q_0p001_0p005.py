...
import scipy
import environment.VQE_files.VQE_tc_4q_0p001_0p005 as vc_tc
...
import random
import copy
import environment.curricula as curricula
...
class CircuitEnv():
    ...
    def __init__(self, conf, device):
        ...
        hamiltonian, weights, eigvals, energy_shift = __ham['hamiltonian'], __ham['weights'],__ham['eigvals'], __ham['energy_shift']
