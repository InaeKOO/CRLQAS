...
from environment.environment_tc_4q_0p001 import CircuitEnv
import agents
        ...
        if done:
            wandb.log(
                {"test_final/episode_len": itr,
                 ...
                 "test_final/return": sum([x * y for x, y in zip(rewards4return, [agent.gamma ** i for i in
                                                                                  range(1, len(rewards4return) + 1)])]),
        ...
        if done:
            ...
            wandb.log(
                {"train_final/episode_len": itr,
                 ...
                 "train_final/return": sum([x * y for x, y in zip(rewards4return, [agent.gamma ** i for i in range(1,
                                                                                                                   len(rewards4return) + 1)])]),
